 ...
 **/
 ...
 void bmp280_init() {
     ...
     i2c_write_blocking(i2c_default, BMP_ADDR, buf, 2, false);
 ...
 void bmp280_read_raw(int32_t* temp, int32_t* pressure) {
     ...
     i2c_write_blocking(i2c_default, BMP_ADDR, &reg, 1, true);  // true to keep master control of bus
     i2c_read_blocking(i2c_default, BMP_ADDR, buf, 6, false);  // false - finished with bus
 ...
 int32_t bmp280_convert_pressure_qs(int32_t pressure, int32_t temp, struct bmp280_calib_param* params) {
    int32_t result = bmp280_convert_pressure(pressure, temp, params);
    result = (result * QS_TO_KPA_RATIO) / 1000;
    return result;
 }
 ...
 void bmp280_get_calib_params(struct bmp280_calib_param* params) {
     ...
     i2c_read_blocking(i2c_default, BMP_ADDR, buf, NUM_CALIB_PARAMS, false);  // false, we're done reading
